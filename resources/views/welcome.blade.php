...
<html lang="en">
    <head>
        ...
        {{-- <link rel="stylesheet" href=" {{ asset('public/frontend/css/bootstrap.minimages.css') }}"> --}}
        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.min.css">
         ...
         <style>
            ...
            .owl-carousel .owl-wrapper, .owl-carousel .owl-item:nth-child({{ $key + 1 }}) .item
                {
                    background: url('{{ asset('public/upload/slider/'.$slider->image) }}');
                    background-size: cover;
                }
            @endforeach               
        </style>
        {{-- Data Showing By HomeController --}}
    ...
    <body data-spy="scroll" data-target="#template-navbar">
                        ...
                        <div class="col-md-10 col-md-offset-1">
                            <ul id="menu-pricing" class="menu-price">
                                ...
                                @foreach($items as $item)
                                    ...
                                    <a href="#">
                                        <img src="{{ asset('public/upload/item/'.$item->image) }}" class="img-responsive" alt="Item" style="height: 230px;width: 300px;">
                    ...
                    <div class=" section-content">
                        <div class="row">
                            <div class="col-md-5 col-sm-6">
                                <form class="reservation-form" method="POST" action="{{ route('reservationpost') }}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
            ...
            <div class="container-fluid color-bg">
                <div class="row dis-table">
                    ...
                    <div class="col-xs-6 col-sm-6 dis-table-cell">
                        <div class="section-content">
                            <p>Islamia College Road,Boyra,Khulna,BANGLADESH</p>
                            <p>+880 1839943309</p>
                            <p>aninsunroy17@gmail.com </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-md-offset-3">
                            <ul class="center-block">
                                <li><a href="https://www.facebook.com" target="_blank" class="fb"></a></li>
                                <li><a href="https://twitter.com" target="_blank" class="twit"></a></li>
                                <li><a href="https://www.google.com" target="_blank" class="g-plus"></a></li>
                                <li><a href="https://www.linkedin.com" target="_blank" class="link"></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6 col-md-offset-3">
                        <div class="copyright text-center">
                            <p>
                                &copy; Copyright, {{ date('Y') }} <a href="#">Mama's Kitchen.</a> Developed by <a href="#">Anindya Sunder Roy</a> Theme by <a href="http://themewagon.com/"  target="_blank">ThemeWagon</a>
                            </p>
                        </div>
                    </div>
                </div>
       ...
       {{--  <script src=" {{ asset('public/frontend/js/bootstrap.minimages.js')}}"></script> --}}
